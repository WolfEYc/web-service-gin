...
type Quote struct {
	ID                      primitive.ObjectID `json:"_id" example:"63f79148c3a63a346225fd99"`
	UserId                  primitive.ObjectID `json:"userid" example:"63f78fc8c3a63a346225fd96"`
	GallonsRequested        int32              `json:"gallonsrequested" example:"99999"`
	DeliveryAddress         string             `json:"deliveryaddress" example:"best st"`
	DeliveryDate            primitive.DateTime `json:"deliverydate" swaggertype:"primitive,string" example:"2023-02-24T00:00:00Z"`
